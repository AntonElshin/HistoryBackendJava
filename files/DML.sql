...
insert into distance (id, distance_name, entrance_fee, racer_limit) values
    (1, 'FULL', 1400.00, null);

-- inserts into registration

insert into registration (id, last_name, first_name, middle_name, birth_date, gender, email, mobile_phone, is_paid) values
